...
def build_hash_table(root_dir):
    # Dict[str, list]: size in bytes as the key and the value represents a list of full paths of files having same size
...
if __name__ == '__main__':
    ...
    for file_list in duplicates_result.values():
        try:
            ...
            # We avoid using the length which may be 'expensive' if there are many duplicates
            _ = file_list[1]
